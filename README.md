...
- Cuando `TIPO COMPROBANTE` es `NC`, todos los importes se multiplican por `-1`: precios, bases gravadas, conceptos, totales y cobros invierten el signo informado por el Excel (`-100` se envía como `100`; `100` se envía como `-100`).
